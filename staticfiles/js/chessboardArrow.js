    ...
    window['ChessBoard'] = window['ChessBoard'] || function(containerElOrId, cfg) {
        ...
        function expandConfig() {
            ...
            if (cfg.hasOwnProperty('pieceTheme') !== true ||
                ...
                cfg.pieceTheme = '/static/img/chesspieces/alpha/{piece}.png';
            }

            // default color board theme
            if (cfg.hasOwnProperty('boardTheme') !== true ||
                cfg.boardTheme.length != 3) {
                cfg.boardTheme = ["url('/static/img/chesspieces/board/lapis/lapis1.png')", "url('/static/img/chesspieces/board/lapis/lapis2.png')", "url('/static/img/chesspieces/board/lapis/lapis2.png')"];
        ...
        */
        ...
        function addBoardTheme() {
            ...
            var borderColor = cfg.boardTheme[2];

            containerEl.find(".white-1e1d7").css("background", wcol)
            containerEl.find(".white-1e1d7").css("color", bcol)
            containerEl.find(".board-b72b1").css("background", borderColor)


            containerEl.find(".black-3c85d").css("background", bcol)
        ...
        */
        ...
        widget.resize = function() {
            ...
            overlayEl.css('width', (SQUARE_SIZE * 9) + 'px');
            overlayEl.css('height', (SQUARE_SIZE * 9) + 'px');
